...
def copy_annotations(filename, dst_img_path, dst_mask_folder, dst_json_folder, masks_path):
    ...
    for json_obj_file in masks_path.glob(f'mask_{img_name}.json'):
        ...
        with open(txt, 'a') as out:
            out.write(f'{json_obj_file} to {dst_json_path}\n')
    ...
    for mask_obj_file in masks_path.glob(f'*mask_{img_name}*.fits'):
        ...
        with open(txt, 'a') as out:
            out.write(f'{mask_obj_file} to {dst_mask_path}\n')
        copyfile(mask_obj_file, dst_mask_path)
    
    with open(txt, 'a') as out:
        out.write(f'{filename} to {dst_img_path}\n')
        ...
        for sample_folder in class_folder.glob('*'):
            ...
            with tqdm(train_split) as t:
                ...
                for filename in t: # filename = data/RadioGalaxies/sample1/imgs/galaxy0001.fits
                    ...
                    copy_annotations(filename, dst_img_path, dst_mask_train_folder, dst_json_train_folder, masks_path)
            ...
            with tqdm(val_split) as t:
                ...
                for filename in t: # filename = data/RadioGalaxies/sample1/imgs/galaxy0001.fits
                    ...
                    copy_annotations(filename, dst_img_path, dst_mask_val_folder, dst_json_val_folder, masks_path)
            ...
            with tqdm(test_split) as t:
                ...
                for filename in t: # filename = data/RadioGalaxies/sample1/imgs/galaxy0001.fits
                    ...
                    copy_annotations(filename, dst_img_path, dst_mask_test_folder, dst_json_test_folder, masks_path)
